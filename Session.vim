...
badd +181 src/cir/cirGate.cpp
badd +149 src/cir/cirGate.h
...
badd +0 src/util/test_random_generator_intel.h
badd +0 src/util/test_random_generator_intel.cpp
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 30 - ((21 * winheight(0) + 20) / 40)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 44 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 189 - ((22 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
189
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 89 + 79) / 159)
exe 'vert 2resize ' . ((&columns * 69 + 79) / 159)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((22 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((4 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
525
normal! zo
let s:l = 654 - ((6 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
654
