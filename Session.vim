...
badd +294 src/cir/cirGate.cpp
badd +150 src/cir/cirGate.h
badd +38 src/cir/cirMgr.h
...
exe 'vert 1resize ' . ((&columns * 67 + 73) / 146)
exe '2resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 2resize ' . ((&columns * 67 + 73) / 146)
exe 'vert 3resize ' . ((&columns * 78 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 117 - ((7 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 154 - ((13 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 89 + 73) / 146)
exe 'vert 2resize ' . ((&columns * 56 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 81 - ((4 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 91 - ((21 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((11 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 66 + 73) / 146)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 145 - ((17 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
145
...
silent! normal! zE
1,43fold
let s:l = 57 - ((56 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
